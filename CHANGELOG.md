...
### 🔧 Maintenance
- chore: update changelog for v1-bet
...
steps:
  - name: Setup Liquibase
    uses: liquibase-github-actions/setup-liquibase@v1-bet
    with:
      liquibase-version: "latest"
```
...
---
**Build Information:**
- **Commit**: cb8518c6fe76e6587561c30e50ccfa0acb2f58f3
- **Branch**: main
- **Build**: #24
- **Timestamp**: 2025-06-23 08:49:24 UTC
