...
export declare const DOWNLOAD_URLS: {
     ...
     */
    readonly OSS_WINDOWS_INSTALLER: "https://package.liquibase.com/downloads/oss/gha/liquibase-windows-x64-installer-{version}.exe";
    readonly OSS_WINDOWS_ZIP: "https://package.liquibase.com/downloads/oss/gha/liquibase-{version}.zip";
    readonly OSS_UNIX: "https://package.liquibase.com/downloads/oss/gha/liquibase-{version}.tar.gz";
    /**
     * Legacy Pro download URL templates (Scarf-tracked)
     * Used only for 'pro' edition (backward compatibility) with versions <= 4.33.0
     */
    readonly PRO_WINDOWS_INSTALLER: "https://package.liquibase.com/downloads/pro/gha/liquibase-pro-windows-x64-installer-{version}.exe";
     ...
     */
    readonly SECURE_WINDOWS_INSTALLER: "https://package.liquibase.com/downloads/secure/gha/liquibase-secure-windows-x64-installer-{version}.exe";
